...
# default window width and height
    ...
    def __init__(self,**kwargs):
        ...
        self.__thisFileMenu.add_command(label="Exit", command=self.__quitApplication,accelerator="Ctrl+E")
        ...
        self.__thisEditMenu.add_command(label="Redo",  command=self.__redo,accelerator="Ctrl+Shift+Z")
        self.__thisEditMenu.add_command(label="Find", command=self.__find,accelerator="Ctrl+F")
...
#FUNCTIONS OF FILE MENUBAR
    def __quitApplication(self):
        self.__root.destroy()

    def __showAbout(self):
        showinfo("Notepad","A Python alternative to notepad")
...
#FUNCTIONS OF EDIT MENUBAR
    ...
    def __find(self):
        self.__thisTextArea.event_generate("<<Find>>")
